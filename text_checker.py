...
def find_precise_info(text):
    ...
    def find_card_numbers(text):
        ...
        cards = [
            ...
            # UnionPay
            r'\b6\d{3}[-\s]?\d{4}[-\s]?\d{4}[-\s]?\d{4}\b',  # 16 цифр
            r'\b6\d{7}[-\s]?\d{10}\b',  # 18 цифр
            r'\b6\d{6}[-\s]?\d{4}[-\s]?\d{4}[-\s]?\d{4}\b', #19 цифр
            # Maestro
            r'\b(?:50|5[6-9]|6[0-9])\d{2}[-\s]?\d{4}[-\s]?\d{4}[-\s]?\d{4}\b',  # 16 цифр
            r'\b(?:50|5[6-9]|6[0-9])\d{2}[-\s]?\d{4}[-\s]?\d{4}[-\s]?\d{5}\b',  # 17 цифр
            r'\b(?:50|5[6-9]|6[0-9])\d{6}[-\s]?\d{10}\b',  # 18 цифр
            r'\b(?:50|5[6-9]|6[0-9])\d{5}[-\s]?\d{4}[-\s]?\d{4}[-\s]?\d{4}\b' #19 цифр
        ]
