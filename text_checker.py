...
def find_phone_numbers(text):
    # шаблоны номеров телефона
     phone_patterns = [
        # +7 (000) 000-00-00 и 8 (000) 000-00-00(как с пробелами, так и без них)
        r'(?:\+7|8)\s?\(\d{3}\)\s?\d{3}-\d{2}-\d{2}\b',
        # +7 000 000-00-00 и +8 000 000-00-00 (как с пробелами, так и без них)
        r'(?:\+7|8)\s?\d{3}\s?\d{3}-\d{2}-\d{2}\b',
        # +7-000-000-00-00 и 8-000-000-00-00
        r'(?:\+7|8)-\d{3}-\d{3}-\d{2}-\d{2}\b',
        # +7 000 000 0000 и 8 000 000 0000 (как с пробелами, так и без них)
